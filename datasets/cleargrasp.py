...
class ClearGraspRealWorld(Dataset):
    ...
    """
    def __init__(self, data_dir, data_type='real-test',split = 'test', **kwargs):
        """
        Initialization.
        ...
        if data_type == "real-test":
            camera_types = ['d415', 'd435']
        else:
            camera_types = ['d435']
...
class ClearGraspSynthetic(Dataset):
    ...
    """
    def __init__(self, data_dir, split = 'train',data_type='synthetic-val', **kwargs):
